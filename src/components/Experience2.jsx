  ...
  return (
    ...
    >
      ...
      <div className="mx-[20px]">
        ...
        <button onClick={handleBook} className="bg-[#00FF00] text-black px-[30px] rounded-[20px] m-[2px] text-xl font-bold">
          Book Now
        </button>
      </div>
    </VerticalTimelineElement>
      ...
      <div className="mt-20 flex flex-col">
        <VerticalTimeline>
          {arr.map((flight, index) => {
            //console.log(flight,new Date(flight.fromDate).toDateString());
